...
public class RandomlySpawn : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InvokeRepeating("randomSpawn4", 1, 1);
        InvokeRepeating("randomSpawn5", 1, 1);
    }
    void Update()
    {
        Rand = 0;
...

    {
        ...
        if (Rand1 >= 90)
        {
           ...
           // Debug.Log("random 2" + Rand1);
            whichEnemy1 = Random.Range(1f, 100);
...

    {
        ...
        if (Rand4 >= 90)
        {
            ...
            {
                //Debug.Log("Which enemy 1 " + whichEnemy);
                Enemy2 = Instantiate(Enemy2, spawn5.transform.position, spawn5.transform.rotation);
                Rand4 = 0;
                whichEnemy4 = 0;
            }
